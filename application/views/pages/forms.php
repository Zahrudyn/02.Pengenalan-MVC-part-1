                                ...
                                <div class="col-lg-6">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-danger" href="<?php echo base_url() . 'index.php/crud/delete/' . $data['id']; ?>">Delete</a></td>
                                            <td><a class="btn btn-success" href="<?php echo base_url() . 'index.php/crud/form_update/' . $data['id']; ?>">Update</a></td>
                                        </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
